 ...
 *
 * Renders the multi-step checkout stepper, Step 1 Address Selection, Step 2 Delivery Options,
 * and Step 3 Payment Method & Order Placement (UPI, Credit/Debit Cards, Net Banking, COD).
 */
@Component({
  ...
  protected async submitPayment(): Promise<void> {
    ...
    if (result.success) {
      this.toast.success(
        ...
        `Order Ref: ${result.orderReference}. Thank you for shopping with us!`,
      );
    } else {
