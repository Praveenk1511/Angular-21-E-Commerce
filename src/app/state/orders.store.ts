...
const MOCK_INITIAL_ORDERS: readonly Order[] = [
  ...
  },
  {
    ...
    lines: [
      {
        ...
        sku: 'AUDIO-ANC-03',
        quantity: 1,
        unitPrice: { currency: 'INR', amountMinor: 18999 },
    ...
    shippingAddress: {
      ...
      type: 'shipping',
      label: 'Office',
      recipient: 'Aarav Sharma (TechCorp India)',
      line1: 'Level 8, Cyber Tower',
    ...
    shipping: {
      method: 'express',
      carrier: 'BlueDart Prime',
      trackingNumber: 'BLUEDART652914881IN',
